"""
Django settings for SMBF project.
...
SECRET_KEY = "django-insecure-t%dk)^d^u=%5sjn_m!%a!s(9&da5h*2#e=o9*k0hz0spun3@(@"
...
WSGI_APPLICATION = "SMBF.wsgi.application"
